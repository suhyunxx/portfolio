<link rel="stylesheet" type="text/css" href="/site/bbs/skin/resp_catalog/style.css" />
...
<!--내용 테이블-->
<table class="ntb-tb-view quick_start" style="width:<%=T_WIDTH%>" cellpadding="0" cellspacing="0">
