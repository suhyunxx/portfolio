...
<table class="ntb-tb-view" style="width:<%=T_WIDTH%>" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		If k_thumbview=True Then
			For fc=1 To 15
				If ImgCheck(c_file(fc-1)) Then Response.Write "<a href=""" & k_uploadfolder & "/" & c_file(fc-1) & """ data-lightbox=""ntb-lb-set""><img src=""" & k_uploadfolder & "/" & c_file(fc-1) & """ style=""max-width:90%"" data-lightbox=""ntb-lb-set"" /></a><br /><br />"
			Next
		End If
