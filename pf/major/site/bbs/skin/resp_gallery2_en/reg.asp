...
<table class="ntb-tb-view" style="width:100%" cellpadding="0" cellspacing="0">
	...
	<tr>
		<th>Tel</th>
		<td class="left"><input type="text"  name="mem_tel" size="15" maxlength="15" value="<%=c_mem_tel%>" class="AXInput" /> ex) +82-2-123-4567</td>
	</tr>
	<%End If%>
	...
	<tr style="display:none">
		<th>E-mail</th>
		<td class="left"><input type="text"  name="email" size="35" maxlength="50" value="<%=c_mem_email%>" class="AXInput" /> ex) abc@webmoa.co.kr</td>
	</tr>
