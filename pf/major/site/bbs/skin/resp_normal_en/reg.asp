...
<table class="ntb-tb-view" style="width:100%" cellpadding="0" cellspacing="0">
	<caption>BBS Write Form</caption>
	<colgroup>
		<col width="20%" />
		<col width="" />
	</colgroup>
	...
	<tr>
		<th>Tel</th>
		<td class="left"><input type="text"  name="mem_tel" size="15" maxlength="15" value="<%=c_mem_tel%>" class="AXInput" /> e.g) +82-2-123-4567</td>
	</tr>
	<%End If%>
	...
	<tr>
		<th>FAX</th>
		<td class="left"><input type="text"  name="mem_fax" size="15" maxlength="15" value="<%=c_mem_fax%>" class="AXInput" /> e.g) +82-2-123-4568</td>
	</tr>
	<%End If%>
	...
	<tr style="display:none">
		<th>E-mail</th>
		<td class="left"><input type="text"  name="email" size="35" maxlength="50" value="<%=c_mem_email%>" class="AXInput" /> e.g) abc@webmoa.co.kr</td>
	</tr>
	...
	<tr>
		<td colspan="2"><textarea cols="" rows="" name="content" id="content" style="width:100%; height:250px"><%=c_content%></textarea></td>
	</tr>
	...
	<tr>
		...
		<%If mode="mod" Then
			...
			<%Else%>
				Currently <span class="font_comcnt"><%=c_file(fc)%></span> file is registered.(<input type="checkbox" name="file<%=fc+1%>_del" value="1" class="vmiddle" />Delete)<br />
			<%End If
		End If%>
	...
	<tr>
		...
		<input type="text" name="txtCaptcha" id="txtCaptcha" value="" class="AXInput vmiddle" style="width:118px" maxlength="5" placeholder="Input captcha code" autocomplete="off" /><br /></td>
	</tr>
	<%End If%>
