...
Function BbsSkinSelect(p_mode)
	Dim strRtn
	strRtn=""
	If p_mode="" Then p_mode="resp_normal"
...
Function SnsMemberIcon(m_id)
	...
	ElseIf InStr(m_id, "_gg_") Then
		SnsMemberIcon = "<img src='/site/member/snsicon/google.png' style='width:20px'> "
	Else
		SnsMemberIcon = ""
	End If
End Function
...
' --------------------------------------------------------
' Function Name : SendKA(수신자명, 수신번호, 발송내용, 발송하려는 템플릿 코드)
' Description : TAS 카카오 알림톡 API 연동
' --------------------------------------------------------
Function SendKA(user_name, user_cell, map_content, template_code)

	user_cell = "82" & Mid(user_cell, 2)

	req_str = "{"
	req_str = req_str & """tas_id"":""webmoa@webmoa.co.kr"","
	req_str = req_str & """send_type"":""KA"","
	req_str = req_str & """auth_key"":""08V8ZN-GPES2C-DB70MQ-K2HR6L_604"","
	req_str = req_str & """data"":"
	req_str = req_str & "["
	req_str = req_str & "{""user_name"":""" & user_name & ""","
	req_str = req_str & """user_email"":""" & user_cell & ""","
	req_str = req_str & """map_content"":""" & map_content & ""","
	req_str = req_str & """sender"":""025444456"","	'발신자번호
	req_str = req_str & """sender_name"":""웹모아"","	'발신자명
	req_str = req_str & """template_code"":""" & template_code & """}"
	req_str = req_str & "]"
	req_str = req_str & "}"

	Set objXMLHTTP = Server.CreateObject("MSXML2.ServerXMLHTTP")
	objXMLHTTP.setOption 2, 13056
	objXMLHTTP.Open "POST", "https://api.tason.com/tas-api/kakaosend", False
	objXMLHTTP.setRequestHeader "Content-Type", "application/json"
	objXMLHTTP.Send req_str
...
'tas_result = SendKA("홍길동", "01027483041", "[웹모아] 연차 신청 알림 - 이름 : 홍길동 - 신청일 : 2022-01-01", "C_AU_018_02_20355")
'Response.write tas_result
%>