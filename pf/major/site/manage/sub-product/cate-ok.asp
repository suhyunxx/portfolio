...
If mode="reg" Then
	...
	Response.Write "<script>alert('생성 되었습니다.');location.href='" & Request.ServerVariables("HTTP_REFERER") & "';</script>"
...
ElseIf mode="mod" Then 
	...
	Response.Write "<script>alert('수정 되었습니다.');location.href='" & Request.ServerVariables("HTTP_REFERER") & "';</script>"
...
ElseIf mode="del" Then 
	...
	Response.Write "<script>alert('삭제 되었습니다.');location.href='" & Request.ServerVariables("HTTP_REFERER") & "';</script>"
