...
<%
p_idx = Request("p_idx")
topnum = Request("topnum")
If topnum="" Then topnum=0

Response.CacheControl = "public" 
Response.ContentType = "application/vnd.ms-excel"
Response.AddHeader "Content-disposition","attachment;filename=POLL_" & topnum & ".xls"
...
If topnum>0 Then Sql = Sql & " AND A.m_id NOT IN (SELECT TOP " & topnum & " B.m_id FROM tbl_poll_adv_a B WHERE B.pa_idx='" & p_idx & "' GROUP BY B.m_id ORDER BY B.m_id) "
Sql = Sql & " GROUP BY A.m_id "
Sql = Sql & " ORDER BY A.m_id "
'Response.Write Sql
Rs.Open Sql, Dbcon, 1
Do Until Rs.EOF
	m_id = Rs("m_id")
