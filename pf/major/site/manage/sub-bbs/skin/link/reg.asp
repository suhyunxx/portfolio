	...
	<div class="tb_info">
		...
		<table>
			...
			<tr>
				...
				<td class="bdt bdr">
				<textarea cols="" rows="" name="content" id="content" style="width:100%; height:80px"><%=c_content%></textarea></td>
			</tr>
			...
			<tr>
				...
				<input type="text" name="txtCaptcha" id="txtCaptcha" value="" class="AXInput vmiddle W100" maxlength="5" autocomplete="off" required />
