            ...
            <div class="content localnewsmap">
                <div class="left">
                    ...
                    <div class="localList">
                        ...
                        <div class="local13 active"><a href="sub13.php">전남</a></div>
                        ...
                        <div class="local17"><a href="sub17.php">충북</a></div>
                    </div>
                </div>
                <div class="right">
                    <!-- <div class="localimg1"><img src="../img/main/map_img_1.png" alt="강원"></div>
                    <div class="localimg2"><img src="../img/main/map_img_2.png" alt="경기"></div>
                    <div class="localimg3"><img src="../img/main/map_img_3.png" alt="경남"></div>
                    <div class="localimg4"><img src="../img/main/map_img_4.png" alt="경북"></div>
                    <div class="localimg5"><img src="../img/main/map_img_5.png" alt="광주"></div>
                    <div class="localimg6"><img src="../img/main/map_img_6.png" alt="대구"></div>
                    <div class="localimg7"><img src="../img/main/map_img_7.png" alt="대전"></div>
                    <div class="localimg8"><img src="../img/main/map_img_8.png" alt="부산"></div>
                    <div class="localimg9"><img src="../img/main/map_img_9.png" alt="서울"></div>
                    <div class="localimg10"><img src="../img/main/map_img_10.png" alt="세종"></div>
                    <div class="localimg11"><img src="../img/main/map_img_11.png" alt="울산"></div>
                    <div class="localimg12"><img src="../img/main/map_img_12.png" alt="인천"></div> -->
                    <div class="localimg13"><img src="../img/main/map_img_14.png" alt="전남"></div>
                    <!-- <div class="localimg14"><img src="../img/main/map_img_14.png" alt="전북"></div>
                    <div class="localimg15"><img src="../img/main/map_img_15.png" alt="제주"></div>
                    <div class="localimg16"><img src="../img/main/map_img_16.png" alt="충남"></div>
                    <div class="localimg17"><img src="../img/main/map_img_17.png" alt="충북"></div> -->
                </div>
            </div>
