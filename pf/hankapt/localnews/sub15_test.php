            ...
            <div class="content localnewsmap">
                <div class="left">
                    ...
                    <div class="localList">
                        ...
                        <div class="local15 active"><a href="sub15.php">제주</a></div>
                        <div class="local16"><a href="sub16.php">충남</a></div>
                        <div class="local17"><a href="sub17.php">충북</a></div>
                    </div>
                </div>
                <div class="right">
                    <div class="localimg15"><img src="../img/main/map_img_17.png" alt="제주"></div>
                </div>
            </div>
            <div class="content tableWrap" style="margin-top:70px;">
                <?
                // 게시판 로드
                include_once "../common/local_test.php";
                ?>
            </div>
        </div>
    </div>
