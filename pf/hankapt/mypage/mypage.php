...
-->
                        ...
                        <tr>
							...
							<td>
								<input type="text" name="m_major" value="<?=$memInfo['m_major']?>">
							</td>
						</tr>
                        <tr>
							<th scope="row"><span>유치원명</span></th>
							<td>
								<input type="text" name="m_company" value="<?=$memInfo['m_company']?>">	
							</td>
						</tr>
						<tr>
							<th scope="row"><span>유치원 전화번호</span></th>
							<td>
								<input type="text" name="m_tel" value="<?=$memInfo['m_tel']?>">
							</td>
						</tr>
						<!-- <tr>
						...
						<tr>
							...
							<td>
								<ul class="__dtbl" style="max-width:390px;">
									<li class="td"><input type="text" class="__form1" name="m_hp1" id="m_hp1" value="<?=$m_hp[0]?>"></li>
									<li class="__line">-</li>
									<li class="td"><input type="text" class="__form1" name="m_hp2" id="m_hp2" value="<?=$m_hp[1]?>"></li>
									<li class="__line">-</li>
									<li class="td"><input type="text" class="__form1" name="m_hp3" id="m_hp3" value="<?=$m_hp[2]?>"></li>
								</ul>
							</td>
						</tr>
