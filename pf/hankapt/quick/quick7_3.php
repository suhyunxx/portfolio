<?php 
// 게시판 정보
$Board['board_id'] = "data3";
$Board['board_name'] = "유아교육진흥원 찾기";
    ...
    <div class="container">
        <div class="inner">
            ...
            <ul class="leftnavi">
                ...
                <li class="active"><a href="quick7_3.php" style="line-height:24px;">유아교육진흥원 찾기</a></li>
            </ul>
            <h4 class="innerTitle innerTitleLeft" style="margin-bottom:30px;">유아교육진흥원 찾기</h4>
