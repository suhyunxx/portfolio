<?php 
// 게시판 정보
$Board['board_id'] = "data1";
$Board['board_name'] = "유치원 찾기";
        ...
        <div class="inner">
            <div class="topnavi">
                <ul>
                    ...
                    <li><span class="lnr lnr-chevron-right"></span></li>
                    <li><a href="#">전국국공립유치원찾기</a></li>
                </ul>
            </div>
            <ul class="leftnavi">
                <li><a href="#">찾아보기</a></li>
                <li class="active"><a href="quick7_1.php">유치원 찾기</a></li>
                <li><a href="quick7_2.php">시도교육청 찾기</a></li>
                <li><a href="quick7_3.php" style="line-height:24px;">유아교육진흥원 찾기</a></li>
            </ul>
            <h4 class="innerTitle innerTitleLeft" style="margin-bottom:30px;">전국국공립유치원 찾기</h4>
            <div class="content localnewsmap contentLeft">
                <div class="left">
                    <p class="lightfont">
                        <span style="display:block; margin-bottom:27px;"><a href="https://e-childschoolinfo.moe.go.kr/main.do" target="_blank"><span style="display:inline-block; width:15px; height:15px; background-color:#000; border-radius:2px; margin-right:14px;"></span><span style="font-size:23px; color:#0072b8;">유치원 알리미 바로가기</span><br></a></span>
