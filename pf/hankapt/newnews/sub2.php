            ...
            <div class="content tableWrap">
                ...
                <table class="refTable">
                    ...
                    <tbody>
                        <tr>
                            <td>10</td>
                            <td><a href="sub2_view.php">보도자료 테스트</a></td>
                            <td>2021-03-23</td>
                            <td>관리자</td>
                        ...
                        <!-- <tr style="border-bottom:none;">
                            <td colspan="5" style="text-align:right;"><a href="sub1_1.php" style="display:inline-block; width:80px; line-height:30px; margin-top:20px; color:#fff; background-color:#0072b8; border-radius:15px; text-align:center;">글쓰기</a></td>
                        </tr> -->
                    </tbody>
                </table>
