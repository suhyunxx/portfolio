        ...
        <div class="inner">
            <div class="topnavi">
                <ul>
                    ...
                    <li><span class="lnr lnr-chevron-right"></span></li>
                    <li><a href="#">교육프로그램 및 매뉴얼</a></li>
                </ul>
            </div>
            <ul class="leftnavi">
                <li><a href="#">자료실</a></li>
                <li class="active"><a href="sub1.php" style="padding:0 7px;">교육프로그램 및 매뉴얼</a></li>
                <li><a href="sub7.php">기타자료</a></li>
