    ...
    <div class="sub_center">
        <div class="sub_top">
            <h3 class="sub_title">
                ...
                <span style="animation-delay: 0.3s;">소</span>
                <span style="animation-delay: 0.4s;">식</span>
            </h3>
            <ul class="snb">
                <li><a href="<?=dir?>new/notice.php">공지사항</a></li>
                <li><a href="<?=dir?>new/kin.php">유아교육뉴스</a></li>
                <li class="on"><a href="<?=dir?>new/group.php">연합회소식</a></li>
        ...
        <div class="board act_board">
            <table class="board1">
                ...
                <tbody>
                    <tr>
                        <td>10</td>
                        <td><a class="textleft" href="<?=dir?>new/group_view.php">연합회소식</a></td>
                        <td>2023-01-08</td>
                        <td>관리자</td>
                    </tr>
                    <tr>
