...
<body>
    ...
    <div class="sub_center">
        <div class="sub_top">
            <h3 class="sub_title">
                <span style="animation-delay: 0s;">유</span>
                <span style="animation-delay: 0.1s;">아</span>
                <span style="animation-delay: 0.2s;">교</span>
                <span style="animation-delay: 0.3s;">육</span>
                <span style="animation-delay: 0.4s;">뉴</span>
                <span style="animation-delay: 0.5s;">스</span>
            </h3>
            <ul class="snb">
                <li><a href="<?=dir?>new/notice.php">공지사항</a></li>
                <li class="on"><a href="<?=dir?>new/kin.php">유아교육뉴스</a></li>
        ...
        <div class="board act_board">
            <table class="board1">
                ...
                <tbody>
                    <tr>
                        <td>10</td>
                        <td><a class="textleft" href="<?=dir?>new/kin_view.php">유아교육뉴스</a></td>
                        <td>2023-01-08</td>
                        <td>관리자</td>
                    </tr>
                    <tr>
