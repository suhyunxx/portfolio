    ...
    <div id="counseling" class="content">
        <div class="center">
            ...
            <div class="counseling_tab">
                   <ul>
                       <li><a href="counseling_list.php">대면상담</a></li>
                       <li class="on"><a href="meta_list.php">메타버스 상담</a></li>
                   </ul>
               </div>
            <div class="sub_inner">
               <form action="">
               ...
               <div class="_list_area">
                   <table>
                       ...
                       <tbody>
                          <tr>
                               <td>10</td>
                               <td class="title"><a href="lock_3.php"><i class="xi-lock"></i>제목<span class="comment_num">3</span></a></td>
                               <td>김수현</td>
                               <td>2022-12-22</td>
                               <td>1</td>
                           </tr>
               ...
               <div class="write_btn"><a href="closed_consult_write.php">상담신청</a></div>
               <div class="page_wrap">
                   <ul class="page">
