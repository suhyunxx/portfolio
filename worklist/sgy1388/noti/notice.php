...
<!--            <h5 class="sub_title">공지사항</h5>-->
            <div class="sub_inner">
               <div class="noti_tab">
                   <ul>
                       <li class="on"><a href="<?=dir?>noti/notice.php">공지사항</a></li>
                   ...
                   <table>
                       ...
                       <tbody>
                          <tr class="fix">
                               ...
                               <td class="title"><a href="notice_view.php">제목<span class="comment_num">3</span></a></td>
                               <td>관리자</td>
                               <td>2022-12-22</td>
                               <td>1</td>
                           </tr>
                           <tr class="fix">
                               ...
                               <td class="title"><a href="">제목<span class="comment_num">3</span></a></td>
                               <td>관리자</td>
                               <td>2022-12-22</td>
                               <td>1</td>
                           </tr>
