            ...
            <div class="sub_inner">
               <div class="noti_tab">
                   <ul>
                       ...
                       <li class="on"><a href="<?=dir?>noti/program.php">프로그램</a></li>
                       <li><a href="<?=dir?>noti/recruit.php">채용공고</a></li>
                       <li><a href="<?=dir?>noti/news.php">센터소식</a></li>
                   </ul>
               </div>
               <div class="view_top">
                   <h5 class="title">청소년 문화체험 - 연극 관람청소년 문화체험 - 연극 관람청소년 문화체험 - 연극 관람청소년 문화체험 - 연극 관람</h5>
                   <ul class="txt_wrap">
               ...
               <ul class=" _detail">
                   <li class="title">신청기간<span>2022.11.18 ~ 2022.11.18</span></li>
                   <li class="title">행사기간<span>2022.11.18 ~ 2022.11.18</span></li>
                   <li class="title">모집인원<span>00</span></li>
                   <li class="title">비용<span>무료</span></li>
               </ul>
               ...
               <div class="_golist"><a href="program.php">목록</a></div>
            </div>
        </div>
    </div>
