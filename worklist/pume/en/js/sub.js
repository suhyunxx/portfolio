...
$('.snbbox2').find('li > a[href="' + 'http://suhyuniiii.dothome.co.kr/worklist/pume/en/' + fileDoc2 + '/' + fileName2 + '"]').parent().addClass('on');

var test = $('.snbbox2').find('li > a[href="' + 'http://suhyuniiii.dothome.co.kr/worklist/pume/en/' + fileDoc2 + '/' + fileName2 + '"]').parent();
