...
$('.depth2').find('li > a[href="' + 'http://suhyuniiii.dothome.co.kr/worklist/pume/' + fileDoc + '/' + fileName + '"]').parent().addClass('on');


var test = $('.depth2').find('li > a[href="' + 'http://suhyuniiii.dothome.co.kr/worklist/pume/' + fileDoc + '/' + fileName + '"]').parent();
